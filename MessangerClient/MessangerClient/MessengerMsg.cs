...
namespace MessangerClient
{
    class MessengerMsg
    {
        ...
        public MessengerMsg(byte _type, string _reciever, string _message)
        {
            msgType = _type;
            reciever = _reciever;
            message = _message;
        ...
        public static MessengerMsg ParseMsg(string value)
        {
            ...
            if (eohIndex > 0)
            {
                ...
                return new MessengerMsg(type, rec, msg);
            }
            return null;
        }

        public static MessengerMsg ServiceMsg(byte type)
        {
            return new MessengerMsg(type, "null", "null");
        }
    }
